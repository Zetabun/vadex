...
const STEPS = [
  ...
  },
  {
    ...
    briefing: (s, o) => !ack(o, 'skills') ? brief('skills', 'Ship proficiency', 'Skill tree online', 'Every second Ship Level, starting at Level 3, grants a Skill Point. Drag the map to explore connected paths, then tap a perk to inspect it.', 'Unlock a perk beside the Pilot Core to start a build. Each purchased node opens its connected branches; deeper perks open at Waves 12 and 20. Skills reset on Rewind.', 'Show Skills', { panel: 'skills' }) : null,
    view: (s, o) => ack(o, 'skills') ? ({ kicker: 'Ship proficiency', title: 'Spend a Skill Point', text: 'Open Skills, tap a connected node and unlock a rank.', hint: 'Each purchased node opens adjacent branches. You can reset points freely.', targetNav: 'skills' }) : null,
  },
  {
