...
// read yet. Three berths; twelve expeditions home and the Pathfinder paint is yours.
 ...
 *  core, bp, fragment: the chance of each find. */
export const DESTINATIONS = [
  ...SECTORS.slice(0, 6).map((s, i) => ({ id: 's' + (i + 1), name: s.name, n: i + 1, sector: i, hours: [1, 1.5, 2.5, 3.5, 4.5, 6][i], mat: materialOf(i), matN: 8 + i * 3, worth: 0.3 + i * 0.12, mastery: 6 + i * 3, seed: 0.4, core: 0.05 + i * 0.03, bp: i < 2 ? 0 : 0.02 + i * 0.01, fragment: 0 })), /* no Blueprints so close to home */
  { id: 'void', name: 'The Deep Void', n: 7, sector: 6, hours: 8, mat: 'shard', matN: 30, worth: 1.5, mastery: 30, seed: 0.5, core: 0.35, bp: 0.2, fragment: 0.35, deep: true },
];
