...
export const SECTORS = [
  ...
  { id: 'graveyard', name: 'Lunar Graveyard', waves: 10, boss: 'bastion', mini: 'gravekeeper',
    ...
    pool: [['grunt', 1, 7], ['weaver', 1, 5], ['diver', 1, 4], ['plate', 1, 4], ['aegis', 2, 2.5], ['splitter', 2, 4], ['sniper', 4, 3], ['carrier', 6, 2], ['lancer', 1, 3]] },
  { id: 'nebula', name: 'Red Nebula', waves: 10, boss: 'wyrm', mini: 'veilmother',
    ...
    pool: [['weaver', 1, 6], ['diver', 1, 4], ['phantom', 1, 5], ['mender', 2, 2.5], ['rocketeer', 3, 3.5], ['swarmling', 4, 5], ['aegis', 1, 2], ['splitter', 1, 3], ['sniper', 1, 3], ['plate', 1, 3]] },
  { id: 'machine', name: 'Machine Territory', waves: 10, boss: 'dreadnought', mini: 'foundry',
    ...
    pool: [['plate', 1, 7], ['artillery', 1, 3.5], ['lasher', 2, 3], ['herald', 3, 2.5], ['aegis', 1, 2.5], ['rocketeer', 1, 3], ['sniper', 1, 3], ['carrier', 1, 2], ['mender', 1, 2], ['grunt', 1, 4]] },
  { id: 'hive', name: 'Hive Space', waves: 10, boss: 'oracle', mini: 'broodqueen',
    ...
    pool: [['swarmling', 1, 10], ['splitter', 1, 6], ['carrier', 1, 4], ['lancer', 1, 5], ['herald', 1, 3], ['mender', 1, 3], ['phantom', 1, 3], ['diver', 1, 4], ['lasher', 3, 2], ['artillery', 4, 2]] },
