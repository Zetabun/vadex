...
export const STATION_CORE = [
  ...
  { at: 2, id: 'ring', name: 'Habitat ring', line: 'A spinning ring round the hub' },
  { at: 3, id: 'spire', name: 'Comms spire', line: 'A mast and beacon above it all' },
  { at: 4, id: 'solar', name: 'Solar wings', line: 'Great panels on both arms' },
  { at: 5, id: 'ring2', name: 'Outer ring', line: 'A second, wider ring' },
  { at: 6, id: 'dome', name: 'Observatory', line: 'A glass dome beneath the hub' },
  { at: 7, id: 'yard', name: 'Shipyard', line: 'A frame for building ships' },
  { at: 8, id: 'beacons', name: 'Beacon array', line: 'Lights at every tip' },
  { at: 9, id: 'halo', name: 'Halo ring', line: 'A holographic halo' },
  { at: 10, id: 'crown', name: 'Stellar crown', line: 'The crowning jewel' },
];
