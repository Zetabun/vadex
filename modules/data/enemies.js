...
export const ENEMIES = {
  ...
  lancer:    { name: 'Lancer', hp: 0.7, reward: 1.5, r: 3, cost: 1.6, prio: 3, color: 0xff4d7a, shape: 'lancer', kamikaze: { every: 7, speed: 70, dmg: 6 }, desc: 'Suicide run. Kill it or dodge it.' },
