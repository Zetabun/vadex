...
// G.mode is 'hangar' between sorties and 'sortie' while one is being flown.
import { Sheet, computeSheet } from '@last-orbit/progression/stats.js';
import { bus } from '@last-orbit/core/events.js';
export const G = { state: null, sheet: new Sheet(), world: null, mode: 'hangar', paused: false, debugSpeed: 1, headless: false, renderer: null };
/** Recompute derived stats after any pick/purchase/unlock. Cheap enough to call eagerly. */
