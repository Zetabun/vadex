...
| `modules/data/` | Definitions and tuning: sectors (and the hidden Origin, `cipher.js`), enemies, bosses, weapons, abilities, cards, relics, ships, Workshop, contracts, balance |
