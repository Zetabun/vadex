...
The gate checks every module's syntax and runs the skill, lifesteal, respec, tier timing, and save migration regression test. Current gameplay build: **v1.18.2**; save schema **13**; onboarding schema **6**.
