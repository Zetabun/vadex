...
Current gameplay build: **v1.18.0**. Save schema: **13**. Onboarding schema: **6**.
...
- The full-screen Loadout pauses combat because it hides the battlefield. Other management panels retain tactical slowdown. Blocking onboarding briefings and guided first purchase freeze all clocks.
