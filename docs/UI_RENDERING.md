...
The collector now displays the awarded Scrap amount at pickup. Shield Capacity becomes available at Wave 3, with recharge upgrades at Wave 6. Its blue HUD bar appears above the green hull bar when a shield source is active. The left status tray starts collapsed and opens to show live and fitted DPS, passive hull repair, shield recharge, Credits per second, hull and shield percentages, lifesteal, active buffs, wave/challenge debuffs and boons. Editable controls retain text selection on iOS; other game controls suppress long-press selection and callouts.
