...
`modules/ui/ui.js` owns the HUD, navigation and management panel. Ordinary management leaves part of the battlefield visible at 30% combat speed; the paused Command Phase enlarges the panel. Ship Loadout instead uses the whole viewport and pauses combat, since the battle cannot be seen. Back to game and close controls remain at the top. The Loadout header also links to Skills after its unlock.
